      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <p className="text-indigo-100 text-lg leading-relaxed mb-8">
            ...
            สมัครฟรีและเข้าถึงคอร์สคุณภาพจากผู้สอนมืออาชีพ
          </p>

          <div className="grid grid-cols-2 gap-6 mt-10">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
              <div className="text-3xl font-bold">100+</div>
              <div className="text-indigo-200 text-sm mt-1">คอร์สเรียน</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
              <div className="text-3xl font-bold">5,000+</div>
              <div className="text-indigo-200 text-sm mt-1">ผู้เรียน</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
              <div className="text-3xl font-bold">50+</div>
              <div className="text-indigo-200 text-sm mt-1">ผู้สอน</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
              <div className="text-3xl font-bold">98%</div>
              <div className="text-indigo-200 text-sm mt-1">พึงพอใจ</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">
            สมัครฟรี! เริ่มเรียนรู้ได้ทันที
          </p>
